...
| --------- |-----------------------------------------------------------------|-----------------------|---------------- |-------------------|
| ![mushic:fire/water](examples/auto-animations/gif/fire-water.gif) | - mushic:fire </br>- mushic:water  | ✔  | ✔</br><sub> (without overlay icon)</sub> | `icon_animation: none` </br> `shape_animation: none` </br> `overlay_icon: none` </br> `overlay_animation: none` |
